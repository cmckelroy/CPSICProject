...
protected:
	...
	string parent_zone;//This is the name of the parent zone, if there is one.
...
public:
	...
	*/
	int retrieve_num_of_cases();//This function retreives the number of cases of coronavirus in that particular zone.
};